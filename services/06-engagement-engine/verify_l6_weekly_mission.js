...
async function verifyL6Mission() {
  ...
  try {
    ...
    const checks = [
      ...
      { name: 'Service Version 5.18.0', pattern: "version: '5.18.0'" },
      ...
      { name: 'WebSocket Physics Enrichment', pattern: "physics_score: safeFloat(physics_score)" },
      ...
      { name: 'L10 Physics Score Signaling', pattern: "physics_score: safeFloat(physics_score)" }
    ];
