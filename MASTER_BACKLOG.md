...
- [✓] **Hardware Health Penalty**: Implemented dynamic reward reduction (-0.05/alarm) in `applyHardwarePenalty`.
- [✓] **Telemetry Precision**: Hardened `safeFloat` with '0.0000' fallback for L11 ML parity.
